...
class rating(models.Model):
	...
	customer = models.OneToOneField('account.customer', verbose_name=_('rating owner'), on_delete=models.SET_NULL, null=True, blank=True)
	...
	customer_images = models.ManyToManyField('rating.image', verbose_name=_('customer images'))

	def validate_rating(self):
		for o in order.objects.filter(customer=self.customer):
